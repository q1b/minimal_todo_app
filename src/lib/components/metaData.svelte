<script lang="ts">
  ...
  const OPEN_GRAPH = {
    ...
    image: {
      src: "/ogImage.jpg?v=1",
      alt: "explore the space" + "explore the nature",
    },
    twitter: "XSukhpreet",
  };
...
<svelte:head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:ital@1&family=Jua&family=Nunito:ital,wght@0,500;1,500&family=Skranji&display=swap"
    rel="stylesheet"
  />
  <!-- OpenGraph Tags -->
